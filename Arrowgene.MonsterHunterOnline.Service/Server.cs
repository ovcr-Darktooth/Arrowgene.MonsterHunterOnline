...
namespace Arrowgene.MonsterHunterOnline.Service
{
    public class Server
    {
        ...
        private void LoadPacketHandler()
        {
            ...
            _csProtoPacketHandler.AddHandler(new CsCmdBattleActorStopMoveHandler());
            _csProtoPacketHandler.AddHandler(new CsCmdUpdateRushStateHandler());
            _csProtoPacketHandler.AddHandler(new CsCmdScheduleFetchPrizeReqHandler());
